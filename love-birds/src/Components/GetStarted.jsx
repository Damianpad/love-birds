  ...
  return (
    <>
      <div className=" flex p-4 flex justify-around w-96 flex-col">
        ...
        <div className="phone:flex-row flex flex-row justify-center items-center ">
          <input
            type="text"
            placeholder="Email"
            className="phone:w-1/2 p-4 m-4 h-10 rounded-lg shadow-[2px_2px_9px] font-eb-garamond bg-cardCream"
          />
          <input
            type="text"
